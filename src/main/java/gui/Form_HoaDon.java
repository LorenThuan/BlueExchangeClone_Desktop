...
public class Form_HoaDon extends JFrame implements ActionListener, MouseListener {
	...
	public Form_HoaDon() {
		...
		pnTimKiem.setBackground(new Color(162, 255, 242));
		...
		txtSoLuong.setBackground(new Color(0, 252, 255));
		...
		btnThemVaoCT_Don.setBounds(551, 325, 62, 29);
		...
		btnTimKH.setBounds(598, 66, 57, 29);
		...
		txtNhanVien.setText("nhân viên đăng nhập");
		...
		btnXoaHD.setBounds(125, 104, 96, 29);
...
//	}
	...
	public void themHDvaoBang(HoaDon hd) {
		...
		String tinhTrang = hd.getTrangThai() ? "Đã thanh toán" : "Chưa thanh toán";
