...
public class HDSDImpl implements HDSDDao{
	...
	ResultSet rs;
	public static ArrayList<HDSD> noiDungHD = new ArrayList<HDSD>(); 
	...
	public HDSDImpl() {
		...
		hdsd = new HDSD("./HinhAnh/ImageHelp/FormBanHang.png", "1. Sau khi bạn nhập thông tin tìm kiếm theo tên hoặc theo mã sản phẩm hoặc chọn size ấn nút tìm kiếm sẽ hiện thông tin được tìm thấy lên bảng danh sách sản phẩm \r\n"
				...
				+ "5. Ô nhập thông tin tìm kiếm khách hàng cũ đã mua hàng của cửa hàng trước đó theo tên hoặc số điện thoại khách hàng \r\n"
				+ "khi ấn nút tìm kiếm bên phải sẽ hiển thị danh sách khách hàng thả xuống để từ đó có thể lựa chọn tên khách hàng sẽ \r\n"
				+ "hiển thị thông tin số điện thoại theo tên khách hàng \r\n"
				...
				+ "10.Danh sách hóa đơn, nếu có đơn hàng ở trạng thái \"Chưa thanh toán\", có thể chọn hóa đơn chưa thanh toán \r\n"
				+ "và tiến hành thanh toán thì bảng danh sách hóa đơn sẽ được cập nhật \r\n"
				+ "trạng thái của hóa đơn đó thành \"Đã thanh toán\" \r\n"
